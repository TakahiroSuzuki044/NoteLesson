...
class LevelSelectViewModel(context: Context) : ViewModel() {
    val pleaseSelectLevelText = Characters.PLEASE_SELECT_LEVEL.getString(context)
    val level1Text = Characters.LEVEL_1.getString(context)
    val level1ImageRes = R.mipmap.level_1
    val level1GameLevel = GameLevel.LEVEL1
    val level2Text = Characters.LEVEL_2.getString(context)
    val level2ImageRes = R.mipmap.level_2
    val level2GameLevel = GameLevel.LEVEL2
    val level3Text = Characters.LEVEL_3.getString(context)
